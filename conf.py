...
project = 'Python pour la physique-chimie'
copyright = 'THERINCOURT David - Lycée Roland Garros'
...
latex_elements = {
    ...
    \vfill
    \small \textit{Plus d'informations sur }{\href{https://physique-chimie-python.readthedocs.io/}{https://physique-chimie-python.readthedocs.io/}}
    \end{titlepage}
    \clearpage
    \pagenumbering{roman}
    \tableofcontents
...
latex_documents = [
    (master_doc, 'physique-chimie-python.tex', 'Python pour la physique-chimie',
...
man_pages = [
    (master_doc, 'Python', 'Python pour la physique-chimie',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Python', 'Python pour la physique-chimie',
     author, 'Python', 'Python pour la physique-chimie',
     'Miscellaneous'),
]
